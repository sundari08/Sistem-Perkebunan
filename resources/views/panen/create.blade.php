            ...
            <form method="POST" action="{{ route('panen.store') }}" id="formHasilPanen">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="tgl" required value="{{ old('tgl', date('Y-m-d')) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="blok" required placeholder="Contoh: C023X, D018X" value="{{ old('blok') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Mandor -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Mandor <span class="text-red-500">*</span></label>
                        <input type="text" name="mandor" required value="{{ old('mandor') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Kerani -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Kerani <span class="text-red-500">*</span></label>
                        <input type="text" name="kerani" required value="{{ old('kerani') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- TPH -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">TPH <span class="text-red-500">*</span></label>
                        <input type="number" name="tph" required value="{{ old('tph', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Pemanen -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Pemanen <span class="text-red-500">*</span></label>
                        <input type="text" name="pemanen" required value="{{ old('pemanen') }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Janjang -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Janjang <span class="text-red-500">*</span></label>
                        <input type="number" name="janjang" required value="{{ old('janjang', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Matang -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Matang <span class="text-red-500">*</span></label>
                        <input type="number" name="matang" required value="{{ old('matang', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Mentah -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Mentah</label>
                        <input type="number" name="mentah" value="{{ old('mentah', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Kurang Matang -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Kurang Matang</label>
                        <input type="number" name="kurangmatang" value="{{ old('kurangmatang', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Lewat Matang -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Lewat Matang</label>
                        <input type="number" name="lewatmatang" value="{{ old('lewatmatang', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Partenor Carpi -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Partenor Carpi</label>
                        <input type="number" name="partenorcarpi" value="{{ old('partenorcarpi', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>

                    <!-- Buah Batu -->
                    <div>
                        <label class="block text-gray-700 font-bold mb-2">Buah Batu</label>
                        <input type="number" name="buahbatu" value="{{ old('buahbatu', 0) }}" class="w-full border rounded-lg px-3 py-2">
                    </div>
                </div>
