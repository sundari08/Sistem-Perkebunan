        ...
        <form method="POST" action="{{ route('panen.store') }}" id="formHasilPanen">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    @if($isAdmin)
                        <select name="estate_id" id="estate_id" required class="w-full border rounded-lg px-3 py-2">
                            ...
                            @foreach($estates as $id => $estate)
                                <option value="{{ $id }}" data-nama="{{ $estate['nama'] }}" data-divisi="{{ json_encode($estate['divisi']) }}">
                                    {{ $estate['nama'] }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <input type="text" name="blok" id="blok" required 
                ...
                <div>
                    ...
                    <input type="text" name="mandor" id="mandor" required 
                           value="{{ old('mandor') }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="kerani" id="kerani" required 
                           value="{{ old('kerani') }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="tph" id="tph" required 
                           value="{{ old('tph', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="pemanen" id="pemanen" required 
                           value="{{ old('pemanen') }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="janjang" id="janjang" required 
                           value="{{ old('janjang', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="matang" id="matang" required 
                           value="{{ old('matang', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="mentah" id="mentah" 
                           value="{{ old('mentah', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="kurangmatang" id="kurangmatang" 
                           value="{{ old('kurangmatang', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="lewatmatang" id="lewatmatang" 
                           value="{{ old('lewatmatang', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="partenorcarpi" id="partenorcarpi" 
                           value="{{ old('partenorcarpi', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="buahbatu" id="buahbatu" 
                           value="{{ old('buahbatu', 0) }}"
                           class="w-full border rounded-lg px-3 py-2">
                </div>
            </div>
